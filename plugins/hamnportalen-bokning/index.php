...
function booking_override() {
  ...
  //importing styles
  wp_register_style('bookingStyle', $plugin_url . '/bookingStyle.css');
  wp_enqueue_style('bookingStyle');
  wp_register_style('bookingStyleCalendar', $plugin_url . '/bookingStyleCalendar.css');
  wp_enqueue_style('bookingStyleCalendar');
  wp_register_style('bookingStyleForm', $plugin_url . '/bookingStyleForm.css');
  wp_enqueue_style('bookingStyleForm');

  //importing scripts
  wp_register_script('bookingScript', $plugin_url . '/bookingScript.js', [], false, true);
