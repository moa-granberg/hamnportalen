...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$hamnportalen_tema_description = get_bloginfo( 'description', 'display' );
			if ( $hamnportalen_tema_description || is_customize_preview() ) :
				?>
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'hamnportalen_tema' ); ?></button>
			<?php
			wp_nav_menu(
				array(
